...
import com.nnt.repository.OrderItemRepository;
...
//        brand 3 => 1 watch
    ...
    public Order findOrderById(Long id) throws Exception {
        return orderRepository.findById(id).orElseThrow(() -> new Exception("Order was not found..."));
    }
    ...
    public OrderItem getOrderItemById(Long id) throws Exception {
        return orderItemRepository.findById(id).orElseThrow(() -> new Exception("Order item was not existed..."));
    }
}
