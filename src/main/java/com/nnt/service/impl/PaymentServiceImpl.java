...
import com.nnt.repository.OrderRepository;
import com.nnt.repository.PaymentOrderRepository;
import com.nnt.service.PaymentService;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentOrder getPaymentOrderById(Long orderId) throws Exception {
        return paymentOrderRepository.findById(orderId).orElseThrow(() -> new Exception("Payment order was not found..."));
    }
    ...
    public PaymentOrder getPaymentOrderByPaymentId(String orderId) throws Exception {
        ...
        if (paymentOrder == null) {
            throw new Exception("Payment order was not found with provided payment link ID...");
        }
        return paymentOrder;
    }
    ...
    @Override
    public PaymentLink createRazorPayment(User user, Long amount, Long orderId) throws RazorpayException {
        amount = amount * 100;
        try {
            RazorpayClient razorpay = new RazorpayClient(apiKey, apiSecret);
